...
from Utilities import prepocessSubsequence, get_label, get_scoreCycleList_from_sliding
...
if __name__ == '__main__':
    ...
    similarity_score=IDK_T(X,t=100,psi1=8,width=cycle,psi2=4)
    anomaly_score=-similarity_score
    auc = roc_auc_score(ground_truth, anomaly_score)
    print(auc)
    # IDK square using a sliding window
    w=cycle-50
    sliding_score=IDK_square_sliding(X,t=100,psi1=2,width=w,psi2=4)
